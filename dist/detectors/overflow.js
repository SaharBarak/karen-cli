...
function detectOverflow(snapshots, _config) {
    const issues = [];
                ...
                issues.push({
                    ...
                    fix: {
                        ...
                        code: {
                            ...
                            explanation: 'Constrains the element to its container width and adds horizontal scrolling if needed',
                        },
                    },
                });
            }
