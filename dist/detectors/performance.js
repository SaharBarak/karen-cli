...
exports.detectPerformance = detectPerformance;
const id_js_1 = require("../utils/id.js");
function detectPerformance(snapshots, _config) {
    const issues = [];
 ...
 */
function extractPerformanceMetrics(snapshot) {
